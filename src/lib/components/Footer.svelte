...
<footer class="footer footer-center p-10 bg-gray-800 text-base-content rounded">
    <div class="grid grid-flow-col gap-4">
      ...
      <a class="link link-hover text-white" href="./transactions">Transactions</a> 
    </div> 
    <div>
      <div class="grid grid-flow-col gap-3">
        <a href="https://github.com/PodYapolskiy/mydget.git"><img src={icon2} alt="github"></a>
        <a href="https://t.me/podyapolskiyaa"><img src={icon3} alt="telegram"></a>
        <a href="https://mail.google.com/mail/u/1/#inbox"><img src={icon1} alt="email"></a>
      </div>
    </div> 
    <div>
